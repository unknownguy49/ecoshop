...
const blogPosts = [
  ...
  },
  {
    ...
    excerpt:
      "Behind the scenes look at how our platform promotes eco-friendliness and supports conscious consumers.",
    content: "Full article content would go here...",
    author: "EcoShop Team",
    date: "2024-01-15",
    readTime: "6 min read",
  ...
  },
  {
    ...
    image:
      "https://i.pinimg.com/736x/10/77/78/1077782ef2430c356dd5b85939a26167.jpg",
    featured: false,
    likes: 203,
    shares: 91,
  },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-lg max-w-2xl mx-auto">
            Discover sustainable living tips, eco-friendly brands, and the
            latest in green technology. Join our community of conscious
            consumers.
          </p>
        </div>
        ...
        <Card className="bg-gradient-to-r from-green-100 to-emerald-100 dark:from-green-900 dark:to-emerald-900 border-green-200 dark:border-green-800">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6 max-w-2xl mx-auto">
              Get the latest articles, eco-tips, and sustainable living guides
